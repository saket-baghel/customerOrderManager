...
app.controller('CustomersController', function ($scope, customersService) {
    ...
    $scope.insertCustomer = function () {
        ...
        var ordersProduct = $scope.newCustomer.product;
        var ordersPrice = $scope.newCustomer.price;
        var ordersQuantity = $scope.newCustomer.quantity;
        var ordersOrderTotal = $scope.newCustomer.quantity * $scope.newCustomer.price;        
        customersService.insertCustomer(firstName, lastName, city, ordersProduct, ordersPrice, ordersQuantity, ordersOrderTotal);
        
        //customersService.insertCustomer(firstName, lastName, city, order);
...
app.controller('CustomerOrdersController', function ($scope, $routeParams, customersService) {
    ...
    var d={};
    d.product = $scope.newOrder.product;
    d.price = $scope.newOrder.price;
    d.quantity = $scope.newOrder.quantity;
    d.orderTotal = $scope.newOrder.price * $scope.newOrder.quantity;
    
    $scope.customer.orders.push(d);
